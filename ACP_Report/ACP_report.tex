...
a trend is decreasing (Pr(Trend \textless{} 1)) for bird species on the
annual Arctic Coastal Plain Aerial Breeding Population Survey (ACP
Suvey) of Alaska. Index formulas used are species-specific, with
indicated total birds (ITB) used for dimorphic species, such as dark
geese, and sandhill cranes, and total birds (TB) used for monomorphic
species other than dark geese and sandhill cranes and scaup. See the
Methods section for detailed index definitions and trend calculations.
Estimates are not corrected for incomplete detection, but trends do
...
{\centering \includegraphics{"//ifw7ro-file.fws.doi.net/datamgt/mbm/mbmwa_008_ACP_Aerial_Survey/documents/images/Crew_picture_Wilson_Safine_ACP_2018_2024.jpg"}
