...
kable(table2, digits = 0, booktabs = TRUE, longtable=TRUE, format.args = list(big.mark = ","), caption=cap, align = "llrrrrcc", col.names = c("Species", "Index", "Average", "SE", "Average", "SE", "Trend (CI)", "Probability"), linesep = "") %>%
  kable_styling(font_size=10, position="center") %>%
  add_header_above(bold = TRUE, c(" "=1, " "=1, "3-Year" = 1, " "=1, "Long-term" = 1, 
                                  " "=1,"Long-term"=1, "Trend < 1"=1)) %>%
  row_spec(row = 0, bold = TRUE)
...
Wilson, H.M., Swaim, M. A., Safine, D.E., Frost, C.J., Osnas E.E., and T.K. Zeller. 2025. Population indices, trends, and distribution of breeding waterbirds on the Yukon-Kuskokwim Delta, Alaska, 1985-2024. Anchorage, Alaska: U.S. Fish and Wildlife Service, Migratory Bird Management.**REPLACE ACP DOI WITH YKD <https://doi.org/10.7944/dqf4-2z27>
